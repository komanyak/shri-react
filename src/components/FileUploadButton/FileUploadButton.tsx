...
import { useCsvAnalyticsStore , type HighlightStats} from "../../store/csvAnalyticsStore";
...
export const FileUploadButton: React.FC<FileUploadButtonProps> = ({ isLoading, stats, onFilesSelected }) => {
  ...
  return (
    <div className={styles.fileSelection}>
      ...
      >
        {isLoading ? <div className={styles.loader} /> : selectedFile ? (
